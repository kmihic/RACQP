...
function [sol, model]=verify_Markowitz_portfolio_selection_data(filename, low_rank, max_time, solver)
...
if(nargin > 3 && strcmp(solver,'gurobi'))
  disp('Running Gurobi')
...
% if(p_cut > 0)
%   disp("SUM OF X SOL ")
%   disp(nnz(round(sol.sol_x(model.binary))))
% end
